...
const EXPECTED = {
  validator: ['CV', 'ROLE_DESCRIPTION', 'INSTRUCTIONS', 'LANGUAGE', 'OUTPUT'],
  evaluator: ['CV', 'ROLE_DESCRIPTION', 'INSTRUCTIONS', 'LANGUAGE', 'EXPECTED_FACTS', 'FORBIDDEN_CLAIMS', 'OUTPUT'],
  pairwiseEvaluator: ['CV', 'ROLE_DESCRIPTION', 'INSTRUCTIONS', 'LANGUAGE', 'OUTPUT_A', 'OUTPUT_B'],
